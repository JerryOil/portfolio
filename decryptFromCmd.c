...
int main(int argc, char *argv[])
{
    ...
    if (argc !=4) {
        ...
        i=0;
        //L diavazw edw to 1-o xarakthra gia na vgei teleio, alliws pros8etei 1 extra byte sto telos toy 2ou arxeiou(amelhteo, apla oxi teleio)
        ...
        while (!feof(fp1)) {
            ...
            //L diavasma xarakthra apo 1-o arxeio edw, alliws pros8etei 1 extra byte sto telos toy 2-ou arxeia(amelhteo, apla oxi teleio)
            fread(&ch,sizeof(char),1,fp1);//L enallaktika ch=fgetc(fp1); (mono gia txt arxeia)
			i++;
